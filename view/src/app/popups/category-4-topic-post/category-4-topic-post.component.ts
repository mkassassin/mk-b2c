...
@Component({
  selector: 'app-category-4-topic-post',
  templateUrl: './category-4-topic-post.component.html',
  styleUrls: ['./category-4-topic-post.component.css']
})
export class Category4TopicPostComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<Category4TopicPostComponent>,
  ...
  submit() {
    ...
    this.Service.Category4TopicPostSubmit(this.PostForm.value).subscribe(datas => this.ValidateData(datas));
  }
